...
import { columns } from "@/components/admin/package/table/columns";
import AddPackageDialog from "@/components/admin/package/AddPackageDialog";
  ...
  return (
    <div className="w-full">
      <div className="flex items-center py-3 gap-2">
        {/* Search Bar */}
        <Input
          placeholder="Filter name package..."
