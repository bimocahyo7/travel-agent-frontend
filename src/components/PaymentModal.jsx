...
import { Upload, Check, AlertCircle, CreditCard, Wallet, QrCode } from 'lucide-react';
...
export default function PaymentModal({ isOpen, onClose, bookingDetails, onConfirm }) {
    ...
    const handleConfirmPayment = () => {
        ...
        alert("Pesanan berhasil dibuat! Tunggu tim kami untuk mengkonfirmasi pesanan anda"); // Simple notification
    ...
    const renderPaymentMethod = () => {
        const commonClasses = "bg-white p-6 rounded-lg shadow-sm border transition-all hover:shadow-md";
                    ...
                    <div className={commonClasses}>
                        <div className="flex flex-col items-center justify-center">
                            ...
                            <p className="text-center mb-4">
                                <span className="text-sm text-gray-600">Kode Pembayaran:</span><br />
                                <span className="font-mono font-bold text-lg">{paymentCode}</span>
                            </p>
                            {renderUploadSection()}
                        </div>
                    </div>
    ...
    return (
        <Dialog open={isOpen} onOpenChange={onClose}>
            <div className="fixed inset-0 bg-black/50 backdrop-blur-sm flex items-center justify-center">
                <div className="bg-gradient-to-br from-white to-gray-50 rounded-xl w-[95vw] h-[95vh] max-w-7xl flex flex-col shadow-2xl overflow-auto"> {/* Modified this line */}
                    {/* Header */}
                    ...
                    {/* Content */}
                    <div className="flex-1 p-6 overflow-y-auto"> {/* Modified this line */}
                        <div className="grid lg:grid-cols-2 gap-6">  {/* Removed h-full */}
                            ...
                            <div className="backdrop-blur-md bg-white/50 p-4 rounded-xl shadow-lg flex flex-col">
                                <div className="space-y-3">
                                    ...
                                    <div className="flex items-center justify-between p-3 bg-yellow-50 rounded-lg">
                                        ...
                                        <span className="font-semibold">{bookingDetails.vehicle.name} - {bookingDetails.vehicle.type}</span>
                                    </div>
                                    ...
                                    <div className="flex items-center justify-between p-3 bg-pink-50 rounded-lg">
                                        <span className="text-sm text-pink-700">Jumlah Penumpang</span>
                                ...
                                <div className="mt-4 bg-white/80 rounded-lg p-4 flex-1">
                                    <p className="font-semibold mb-2 text-gray-700">Instruksi Pembayaran:</p>
