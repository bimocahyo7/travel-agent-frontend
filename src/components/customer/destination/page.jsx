...
export default function BookingDestinationPage() {
    ...
    return (
        <div className="max-w-5xl mx-auto py-8 px-4">
            <h1 className="text-3xl font-bold mb-8 text-center text-gray-800">Daftar Booking Destination</h1>

            <div className="mb-6 flex justify-end">
                <div className="relative">
                    <input
                        type="text"
                        placeholder="Cari destinasi atau status..."
                        value={search}
                        onChange={e => {
                        ...
                        <div className="bg-gray-50 p-4 rounded-lg mb-6">
                            ...
                            <div className="grid grid-cols-2 gap-4">
                                <div>
                                    ...
                                    <p className="font-semibold text-gray-800">{selectedBooking.destination?.name}</p>
                                </div>
                                <div>
                                    <p className="text-sm text-gray-600">Vehicle</p>
                                    <p className="font-semibold text-gray-800">{selectedBooking.vehicle?.name}</p>
                                </div>
                                <div>
            ...
            {showPayment && selectedBooking && (
                <PaymentModal 
                    ...
                    bookingDetails={{
                        ...
                        destination: selectedBooking.destination?.name,
                        date: selectedBooking.booking_date,
                        passengers: selectedBooking.jumlah_penumpang,
            ...
            {loading ? (
                            ...
                            <div key={booking.id} className="bg-white rounded-lg shadow-md hover:shadow-lg transition-shadow duration-300 border-2 border-gray-200">
                                <div className="p-6">
                                    <div className="flex justify-between items-start mb-4">
                                        <div>
                                            <h3 className="text-lg font-bold text-gray-800">{booking.destination?.name}</h3>
                ...
                <div className="text-center py-12 text-gray-500">
                    ...
                    <p className="mt-4 text-lg">Tidak ada booking destination.</p>
                </div>
            )}
        </div>
    );
