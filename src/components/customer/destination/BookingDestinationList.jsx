          ...
          <div className="bg-white p-8 rounded-lg max-w-2xl w-full shadow-xl relative overflow-hidden">
            ...
            <div className="flex justify-between items-start mb-8 relative">
              ...
              <div className="text-right">
                ...
                <p className="text-sm text-gray-500">
                  INV/{formatDate(selectedBooking.booking_date)}/
                  {selectedBooking.id}
                </p>
                <p className="text-sm text-gray-500">
            ...
            <div className="bg-gray-50 p-4 rounded-lg mb-6">
              ...
              <div className="grid grid-cols-2 gap-4">
                ...
                <div>
                  ...
                  <p className="font-semibold text-gray-800">
                    {Math.floor(selectedBooking.jumlah_penumpang)} person(s)
                  </p>
                </div>
              </div>
            </div>
        ...
        <>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            {paginatedBookingdes.map((booking) => (
              <div
                key={booking.id}
                className="bg-white rounded-lg shadow-md hover:shadow-lg transition-shadow duration-300 border-2 border-gray-200"
              >
                <div className="p-6">
                  ...
                  <div className="space-y-2 text-gray-600">
                    ...
                    <div className="flex items-center">
                      ...
                      <span>
                        {Math.floor(booking.jumlah_penumpang)} Penumpang
                      </span>
                    </div>
                    <div className="flex items-center">
                      <svg
