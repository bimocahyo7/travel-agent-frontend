...
function Package() {
  const travelPackages = [
    {
      name: "Beach Getaway",
      description: "A relaxing beach vacation package with luxury accommodations, beach activities, and more.",
    ...
    {
      name: "City Tour",
      description: "Discover the best cities in the world with guided tours, local experiences, and more.",
  ...
  return (
    <section id="packages" className="h-fit [#95BFC4] bg-[#27445D] scroll-mt-12">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-8 pb-20">
        <h1 className="text-4xl font-bold text-center text-white mt-8">Our Packages</h1>
        <p className="text-xl text-center text-slate-300 mt-3 mb-12">
          Choose from a variety of travel packages designed to fit your dream destinations and budget.
        </p>
            ...
            <div
              ...
              <div className="p-5">
                ...
                <div className="flex items-center justify-between">
                  <span className="text-lg font-bold text-[#b22660]">{pkg.price}</span>
