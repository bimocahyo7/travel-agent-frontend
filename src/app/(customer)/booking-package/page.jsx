...
export default function BookingsPage() {
    ...
    return (
        <section className="max-w-3xl mx-auto p-6">
            <h2 className="text-2xl font-bold mb-4 text-cyan-700">Checkout Pemesanan</h2>
            ...
            <form onSubmit={handleBooking} className="space-y-4">
                ...
                <div className="bg-white rounded-xl shadow p-4">
                    ...
                    <p><strong>Nama Paket:</strong> {selectedPackage.name}</p>
                    <p><strong>Tujuan:</strong> {selectedPackage.destination?.location ?? 'Tidak tersedia'}</p>
                    <p><strong>Harga per orang:</strong> Rp {selectedPackage.price.toLocaleString('id-ID')}</p>
                </div>
                ...
                <div className="bg-gray-100 rounded p-4">
                    <p><strong>Total Harga:</strong> Rp {(selectedPackage.price * passengerCount).toLocaleString('id-ID')}</p>
                </div>
